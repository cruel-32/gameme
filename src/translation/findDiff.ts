...
export const ko: Resource = {
  translation: {
    ...
    findDiffGrade5: '아쉽군요. 좀만 더 잘 찾아봐요',
    findDiffGrade6: '음. 정말 어림없는 점수군요',
    findDiffGrade7: '노답. 뭐 하세요? 눈 뜨고 겜하는거 맞죠?',
  },
};
...
export const en: Resource = {
  translation: {
    ...
    findDiffGrade4: 'I was good but I was disappointed',
    findDiffGrade5: 'A little good',
    findDiffGrade6: 'It’s a really low level',
    findDiffGrade7: 'Are you open your eyes?',
  },
};
